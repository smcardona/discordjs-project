const runner = require('../../libs/objects/enigma/pieces.js')
...
module.exports = {
  data: new MessageCommandBuilder()
    ...
    .setAliases('en')
    .setMinArgs(1)
    .setExpectedArgs('<Configuration> | [Text to encrypt]` \n``` Possible characters: 0123456789ABCÇDEFGHIJKLMNÑOPQRSTUVWXYZ!¡¿?()[]{}<>"/+._,:=\'\\``')
    .build(),
  ...
  async execute({ message, text }, _test) {
    ...
    */
    ...
    // Everything here has been moved to /libs/objects/enigma/pieces.js
